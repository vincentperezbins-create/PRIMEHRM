    ...
    <div class="main-container">
      <div class="xs-pd-20-10 pd-ltr-20">
        <div class="d-flex flex-column flex-lg-row justify-content-between gap-3 pb-20">
            <h2 class="mb-1">201 List </h2>
            <p> <?= htmlspecialchars($file['first_name'] . ' ' . $file['last_name']) ?>
            -
            ...
            <div class="card-box height-100-p pd-20">
             ...
             <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-3">
                  <h5 class="mb-0"><strong>File:</strong> <?= htmlspecialchars($file['file_name']) ?></h5>
          ...
          <div class="col-md-4 mb-20">
            <div class="card-box height-100-p pd-20">
             ...
             <div class="card-body">
              ...
              <form method="POST" action="admin_201_action.php" class="mb-3">
              ...
              <form method="POST" action="admin_201_action.php">
                <input type="hidden" name="token" value="<?= htmlspecialchars(generateToken(), ENT_QUOTES, 'UTF-8') ?>">
                <input type="hidden" name="document_id" value="<?= htmlspecialchars((string) $file['document_id'], ENT_QUOTES, 'UTF-8') ?>">
